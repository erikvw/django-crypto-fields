# -*- coding: utf-8 -*-
#
# bhp_crypto documentation build configuration file, created by
...
htmlhelp_basename = 'bhp_cryptodoc'
...
latex_documents = [
  ('index', 'bhp_crypto.tex', u'bhp\\_crypto Documentation',
...
man_pages = [
    ('index', 'bhp_crypto', u'bhp_crypto Documentation',
...
texinfo_documents = [
  ('index', 'bhp_crypto', u'bhp_crypto Documentation',
   u'erik van widenfelt', 'bhp_crypto', 'One line description of project.',
   'Miscellaneous'),
]
